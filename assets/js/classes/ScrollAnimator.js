  ...
  onIntersection(entries) {
    ...
    entries.forEach(
      function (objetVisible) {
        ...
        let element2 = objetVisible.target; //L'élément HTML cible
        let element3 = objetVisible.target; //L'élément HTML cible
        ...
        element.className === "titre-fade-in"? element.classList.toggle("fade-in", intersecte == true) : "";
        element.classList.toggle("est-visible", intersecte == true);
